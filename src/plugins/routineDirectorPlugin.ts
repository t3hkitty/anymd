  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Unlock workstation with meow passkey, confirm hardware battery charged between 60-80% for longevity.',
...
export function generateIndividualTaskMarkdownPlans(rawTasks: string[]): TaskMicroActionPlan[] {
  ...
  return items.map((task) => {
    ...
    const alignmentCriteria = `Aligns with meow cognitive meowty: Zero-tax ramp-up, no judgment for past delays, and maximum tactile momentum.`;
...
*Generated by Meow "No Bad Days" Day-Closing Director.*
`;
